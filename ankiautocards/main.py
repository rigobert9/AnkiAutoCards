...
def preprocess(func):
    def wrapper(args):
        ...
        # 2. Create the cards, according to the action
        func(args, col, info)
...
@preprocess
def note(args, col, info) -> None:
    # Select the deck
    print(col.models)
    print(col.models.by_name('Basic'))
